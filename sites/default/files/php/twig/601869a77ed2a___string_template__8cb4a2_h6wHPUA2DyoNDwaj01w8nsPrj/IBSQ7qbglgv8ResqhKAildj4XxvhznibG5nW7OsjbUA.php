...
/* __string_template__8cb4a266a7ee4ae47a752ae1bff07f4e5eb73b355ddfade3d3e481e14c1e85d5 */
class __TwigTemplate_610b2f44b4bce6bc852db21c5bdfcf84753cb5ac712de42919e026e22af442d3 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"fecha\">";
        // line 2
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["field_fecha"] ?? null), 2, $this->source), "html", null, true);
        echo "</div>
  <div class=\"equipo\">
    <div class=\"nombre\">";
        // line 4
  ...
  <div class=\"estado\">";
    ...
    {
        return "__string_template__8cb4a266a7ee4ae47a752ae1bff07f4e5eb73b355ddfade3d3e481e14c1e85d5";
    }
    ...
    {
        return new Source("", "__string_template__8cb4a266a7ee4ae47a752ae1bff07f4e5eb73b355ddfade3d3e481e14c1e85d5", "");
    }
